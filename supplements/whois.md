...
1. The verifiable presentation MUST be in one of three formats:
    1. A W3C [Verifiable Credentials Data Model](#verifiable-credentials-data-model) Standard JSON-LD [[ref: Data Integrity Proof]] Verifiable Presentation MAY be used.
    1. A W3C Verifiable Credentials Data Model Standard [JSON Web Token Verifiable Presentation](#json-web-token-verifiable-presentation) MAY be used.
