...
inception event of a KERI identifier--the first item in the [[ref: KEL]].
...
Since an AID is a unique identifier that is inextricably bound to the [[ref: KERI event stream]] from
